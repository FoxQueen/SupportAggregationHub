...
public class BananaCRMConnectorTest extends InvokeTest {
    @Test
    @Override
    public void invokeTest() {
        Map<String, Object> event = MockData.MOCK_BANANA_CONNECTOR_CRM;
        Map<String, Object> expectedOutput = new HashMap<>();
        expectedOutput.put("caseList", MockData.MOCK_RAW_BANANA_DATA);
